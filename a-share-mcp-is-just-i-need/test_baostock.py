...
class CompleteBaostockDataSourceTester:
    ...
    def test_1_get_historical_k_data(self):
        """测试1：K线数据获取"""
        return self.test_function("get_historical_k_data",
    ...
    def test_2_get_stock_basic_info(self):
        """测试2：股票基本信息"""
        return self.test_function("get_stock_basic_info",
                                  self.data_source.get_stock_basic_info,
                                  code=self.test_stock_code)

    def test_3_get_dividend_data(self):
        """测试3：分红数据"""
        return self.test_function("get_dividend_data",
    ...
    def test_4_get_adjust_factor_data(self):
        """测试4：复权因子数据"""
        return self.test_function("get_adjust_factor_data",
    ...
    def test_5_get_profit_data(self):
        """测试5：盈利能力数据"""
        return self.test_function("get_profit_data",
    ...
    def test_6_get_operation_data(self):
        """测试6：运营能力数据"""
        return self.test_function("get_operation_data",
    ...
    def test_7_get_growth_data(self):
        """测试7：成长能力数据"""
        return self.test_function("get_growth_data",
    ...
    def test_8_get_balance_data(self):
        """测试8：偿债能力数据"""
        return self.test_function("get_balance_data",
    ...
    def test_9_get_cash_flow_data(self):
        """测试9：现金流数据"""
        return self.test_function("get_cash_flow_data",
    ...
    def test_10_get_dupont_data(self):
        """测试10：杜邦分析数据"""
        return self.test_function("get_dupont_data",
    ...
    def test_12_get_forecast_report(self):
        """测试12：业绩预告数据"""
        return self.test_function("get_forecast_report",
    ...
    def test_18_get_all_stock(self):
        """测试18：全市场股票列表"""
        return self.test_function("query_all_stock",
                                  self.data_source.get_all_stock, "2017-06-30")

    # ==================== 宏观经济数据功能测试 ====================

    def test_19_get_deposit_rate_data(self):
        """测试19：存款利率数据"""
        return self.test_function("query_deposit_rate_data",
    ...
    def test_20_get_loan_rate_data(self):
        """测试20：贷款利率数据"""
        return self.test_function("query_loan_rate_data",
    ...
    def test_22_get_money_supply_data_month(self):
        """测试22：月度货币供应量数据（修复后）"""
        return self.test_function("get_money_supply_data_month",
    ...
    def test_23_get_money_supply_data_year(self):
        """测试23：年度货币供应量数据（修复后）"""
        return self.test_function("get_money_supply_data_year",
    ...
    def run_all_tests(self):
        ...
        print(
            f"成功率：{(self.success_count + self.no_data_count)/self.test_count*100:.1f}%"
        )
