...
def prepare_dataset(df, tokenizer, max_length=512):
    ...
    eval_tokenized = eval_dataset.map(tokenize_function,
                                      batched=True,
...
def create_model_and_tokenizer():
    ...
    model_name = cwd / "Qwen" / "Qwen3-1.7B"
...
def main():
    """主函数"""
    # 数据路径
    csv_path = cwd / "risk_nasdaq" / "risk_deepseek_cleaned_nasdaq_news_full.csv"
