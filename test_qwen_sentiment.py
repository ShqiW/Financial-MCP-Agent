...
def load_trained_sentiment_model(
        model_path="/root/code/Finance/qwen_sentiment_model"):
    """加载训练好的情感分析模型"""
...
def test_sentiment_model():
    ...
    test_cases = [
        ...
        ("Microsoft announces major layoffs affecting 10,000 employees",
         "MSFT"), ("Google reports disappointing ad revenue decline", "GOOGL"),
    ...
    for i, (text, symbol) in enumerate(test_cases, 1):
        ...
        if predicted_sentiment:
            ...
            print(
                f"预测情感: {predicted_sentiment} ({sentiment_map[predicted_sentiment]})"
            )
        else:
            print("预测情感: 解析失败")
...
def test_sentiment_distribution():
    ...
    sentiment_test_cases = {
        1: [  # 负面
            ...
            "CEO arrested for fraud charges", "Stock crashes 50% in single day"
        ],
        2: [  # 轻微负面
